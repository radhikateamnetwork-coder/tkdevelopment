...
const servicesData = {
  'ui-ux-design': {
    ...
    description: 'We create intuitive, visually stunning interfaces that delight users and drive conversions. Our design process focuses on understanding your users and business goals to deliver experiences that matter.',
  ...
  'web-development': {
    ...
    description: 'We build high-performance websites and web applications using cutting-edge technologies. From simple landing pages to complex web apps, we deliver solutions that scale with your business.',
  ...
  'ecommerce': {
    ...
    description: 'We create powerful e-commerce experiences that convert visitors into customers. Our solutions include custom stores, marketplace integrations, and headless commerce architectures.',
  ...
  'seo-growth': {
    ...
    description: 'We help you get found online through strategic SEO, performance optimization, and growth strategies. Our data-driven approach ensures measurable results and sustainable growth.',
